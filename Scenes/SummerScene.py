    ...
    def tower_event_1():
        ...
        while tower_choice not in tower_options:
            ...
            if map_choice is "1":
                ...
                summer_scene.tower_event_1()
            elif map_choice is "2":
                summer_scene.tower(summer_scene.first_tower_visit)
            elif map_choice is "3":
    ...
    def tower_event_4():
        ...
        while tower_choice not in tower_options:
            ...
            if tower_choice is "1":
                ...
                summer_scene.tower(summer_scene.first_tower_visit)
            elif tower_choice is "3" and summer_scene.timebro_secret:
